package com.weiweb.core.statics;
...
public interface Constant {
	...
	final static String  EXECUTE_CHANGE_USER = "EXECUTE_CHANGE_USER";
	
	/**
	 * 上传文件基本目录
	 */

	public static final String	UPLOADFILE_BASEFILEPATH		= "uploadFile.baseFilePath";
