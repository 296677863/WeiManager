...
import com.weiweb.admin.schedule.util.Constant.ScheduleStatus;
...
public class ScheduleUtils {
    ...
    public static void createScheduleJob(Scheduler scheduler, ScheduleJobModel scheduleJob) {
    	 try {
             ...
             //放入参数，运行时的方法可以获取
             jobDetail.getJobDataMap().put(ScheduleJobModel.JOB_PARAM_KEY, scheduleJob);
    ...
    public static void updateScheduleJob(Scheduler scheduler, ScheduleJobModel scheduleJob) {
    	 try {
             ...
             //参数
             trigger.getJobDataMap().put(ScheduleJobModel.JOB_PARAM_KEY, scheduleJob);
    ...
    public static void run(Scheduler scheduler, ScheduleJobModel scheduleJob) {
    	try {
        	...
        	dataMap.put(ScheduleJobModel.JOB_PARAM_KEY, scheduleJob);
